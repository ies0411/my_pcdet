...
class UniTRMAP(Detector3DTemplate):
    ...
    def build_mm_backbone(self, model_info_dict):
        ...
        mm_backbone_module = mm_backbone.__all__[mm_backbone_name](
            model_cfg=self.model_cfg.MM_BACKBONE, use_map=self.dataset.use_map
        )
    ...
    def build_dense_head(self, model_info_dict):
        ...
        dense_head_module = dense_heads.__all__[self.model_cfg.DENSE_HEAD.NAME](
            ...
            num_class=len(self.dataset.map_classes)
    ...
    def forward(self, batch_dict):
        ...
        if self.training:
            ...
            ret_dict = [
                {"masks_bev": masks_bev, "gt_masks_bev": gt_masks_bev}
                for masks_bev, gt_masks_bev in zip(
                    batch_dict["masks_bev"], batch_dict["gt_masks_bev"]
                )
            ]
            return ret_dict
    ...
    def get_training_loss(self, batch_dict):
        ...
        tb_dict = {"loss": loss_trans.item(), **tb_dict}
