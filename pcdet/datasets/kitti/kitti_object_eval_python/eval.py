...
#         rets = clean_data(all_classes, gt_annos[i], dt_annos[i], current_class, difficulty)
...
#             rets = _prepare_data(all_classes, gt_annos, dt_annos, current_class, difficulty)
...
#     ret = eval_class(all_classes, gt_annos, dt_annos, current_classes, difficultys, 1,
#                      min_overlaps)
...
#     ret = eval_class(all_classes, gt_annos, dt_annos, current_classes, difficultys, 2,
#                      min_overlaps)
...
#             break
#     mAPbbox, mAPbev, mAP3d, mAPaos, mAPbbox_R40, mAPbev_R40, mAP3d_R40, mAPaos_R40 = do_eval(
#         all_classes,gt_annos, dt_annos, current_classes, min_overlaps, compute_aos, PR_detail_dict=PR_detail_dict)
